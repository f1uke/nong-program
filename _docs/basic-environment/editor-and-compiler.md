...
> **หมายเหตุ:** บางครั้งก็จะมีการเรียกคำระหว่าง Source code editor กับ Editor เป็นคำเดียวกันเพื่อลดการเรียกชื่อที่ยาว ดังนั้นหลังจากนี้เราจะเรียกว่า **Editor** เป็นหลักเพื่อจะได้ไม่ต้องพิมพ์หรือเรียกชื่อกันยาวๆ
